        ...
        <div className="space-y-6 text-[15px] leading-[var(--leading-body)] text-[var(--color-text-primary)]">
          <section className="space-y-2">
            ...
            <p className="text-[var(--color-text-secondary)]">
              By creating an account or using ClearPath, you agree to these Terms of Service and our Privacy Policy. If
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--color-text-secondary)]">
              ClearPath is a coaching management platform. We provide software tools (scheduling, messaging, programs,
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc space-y-1 pl-5 text-[var(--color-text-secondary)]">
              ...
              <li>Payment disputes between coach and client are between those parties; ClearPath facilitates tools but does not mediate every dispute.</li>
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--color-text-secondary)]">
              To the fullest extent permitted by law, ClearPath and its suppliers are not liable for indirect,
          ...
          <section className="space-y-2">
            ...
            <p className="text-[var(--color-text-secondary)]">
              ...
              <a href="mailto:support@clearpath.com" className="text-[var(--color-accent)] underline">
