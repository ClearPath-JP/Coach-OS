    ...
    >
      <div className="flex max-w-md flex-col items-center text-center">
        ...
        <div className="mt-8 flex w-full flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            href="/login"
            className="inline-flex min-h-[44px] items-center justify-center rounded-[var(--radius-md)] border border-[var(--border-default)] bg-[var(--bg-subtle)] px-6 text-[15px] font-medium text-[var(--text-primary)] transition-colors hover:bg-[var(--bg-muted)]"
          >
            Sign in differently
          </Link>
        </div>
